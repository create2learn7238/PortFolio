    ...
    <div className="h-full flex flex-col bg-white overflow-hidden">
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-44 flex-shrink-0 bg-gradient-to-b from-[#4f7fc7] to-[#285baa] p-3 flex flex-col text-white">
          <div className="text-sm font-bold mb-3"><i className="bi bi-mortarboard-fill mr-1"></i> Education</div>
          <div className="text-xs opacity-80">Academic background and qualifications</div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-4">
          ...
          <div className="p-3 bg-[#f0f0f0] border border-gray-300 mb-3">
            <div className="flex items-start">
              <span className="text-3xl mr-3"><i className="bi bi-building text-[#4a90d9]"></i></span>
              <div>
                <div className="font-bold text-base">{education.institution}</div>
                <div className="text-sm text-gray-600">{education.degree}</div>
                <div className="text-xs text-gray-500 mt-1">Expected Graduation: {education.graduation}</div>
              </div>
            </div>
          </div>
            ...
            <table className="w-full text-sm">
              <tbody>
                <tr className="border-b border-gray-200">
                  <td className="py-1.5 text-gray-500 w-32">Status:</td>
